export const dashboard = <i className="fas fa-house"></i>;
...
export const signout = <i className="fas fa-right-from-bracket"></i>;
...
export const logout = <i className="fas fa-sign-out"></i>;
...
export const calendar = <i className="fas fa-calendar"></i>;
